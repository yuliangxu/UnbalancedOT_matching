...
beepr::beep()
saveRDS(all_result,paste("result/all_result_d10_linear_","case1_",".rds",sep="")) # create your own result folder
...
all_result = readRDS(paste("result/all_result_d10_linear_","case1_",".rds",sep=""))
# par(mfrow = c(1,3))
stats_name = c("bias","var","mse")
...
egg::ggarrange(p1, p2, p3,nrow = 1, byrow = F,top="case1,d=10,linear")
